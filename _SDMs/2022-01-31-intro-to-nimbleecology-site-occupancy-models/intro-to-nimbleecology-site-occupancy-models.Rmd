...
usually think of latent states as a type of random effect.)
...
take into a math and summing across them. Marginalizing isn't always
this straightforward, because latent states can take many (or infinitely
many) values. We'll explore harder contexts in future posts.
...
The nimbleEcology vignette is here.
