...
Check out the Blog page on this website for more info on species distribution modeling.
...
I worked as a member of the NIMBLE development team under my advisor and co-creator of NIMBLE, Dr. Perry de Valpine. [NIMBLE](r-nimble.org) is an R extension for building and estimating arbitrary statistical models.
